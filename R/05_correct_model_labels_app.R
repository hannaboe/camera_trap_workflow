##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##
## Correct automatic image labels (manual classification) - APP
## Date: 2022-09-29
##
...
## This app is used to correct automatic image labels and thus, assumes that the images have been classified automatically using the script '02_classify_images_automatically.R'.
...
## Open the Rstudio project 'camera_trap_workflow.Rproj', then open the script '05_correct_model_labels_app.R' and run the app
...
source("apps/correct_model_labels_app.R")  # load the app
